	...
	<view>
		...
		<view class="addressModel" v-if="visible">
			<view class="showModel">
				<picker-view :value="current_value1" @change="bindChange" @pickstart="pickstart" @pickend="pickend">
					<picker-view-column>
				...
				<view class="btns">
					...
					<view :class="isPickValue===true?'cancel':'cancel1'" @click="sure_address">
						确定
					</view>
				</view>
			</view>
